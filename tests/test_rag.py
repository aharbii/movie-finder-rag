...
def test_rag() -> None:
    ...
    test_set = {
        "Inception": "A professional thief who steals secrets through use of dream-sharing technology is given the inverse task of planting an idea into the mind of a CEO.",
        ...
        "The Lion King": "A young lion prince is cast out of his heritage by his cruel uncle and must find the courage to return and take back his place as the rightful king.",
        ...
        "The Arrival": "A linguist works with the military to communicate with alien newcomers who have landed giant spacecraft around the world before tensions lead to war.",
    }
